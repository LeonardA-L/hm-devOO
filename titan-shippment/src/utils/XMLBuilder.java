...
public class XMLBuilder {
	...
	// v�rifie si le fichier est lisible et bien form�, et que l'uppermost
	// balise est bien <Reseau> (pour un plan)
	...
	// d�termine s'il s'agit d'un plan ou d'une liste ed livraisons. A appeler a
	// chaque chargement d'un xml.
	...
	// Erreurs prises en charge : longueur n�gative, vitesse n�gative, tron�on :
	// arriv�e = destination
