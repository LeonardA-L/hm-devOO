...
public class Fenetre extends JFrame {
	...
	private void initBtnPanel() {
		...
		Bouton loadMap = new Bouton("loadMap", "Chargement de la carte");
		Bouton loadLivraisons = new Bouton("loadLivraisons", "Chargement des livraisons");
		Bouton calculTournee = new Bouton("calculTournee", "Calcul de la tournée");
